...
//circumference of spool (2πr)mm
#define spoolCirc 94.2 

//steps per full rotation (number from https://github.com/robjampar/Stepper)
...
//setup was done by having exactly 1m of string reeled out on both left and right and a fix disparity of 1m between anchors. This is now set up by user instead.
...
float centerY = 866; //starting y pos
